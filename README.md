...
Next, we have to set up the proper environment for the srcipt (that is, install, if needed, all the necessary packages, etc.). To do this, tun the following in the already running Julia:
