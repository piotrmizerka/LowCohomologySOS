...
function spectral_gaps_certification(h::Function, relations, half_basis; optimizer)
    λₐₚ, Pₐₚ, RG, Δ₁, Iₙ = spectral_gaps_approximated(h, relations, half_basis; optimizer=optimizer)
